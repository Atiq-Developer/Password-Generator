...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-yellow-500 dark:bg-gray-900">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-red-300 dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="mx-auto max-w-md space-y-6">
          {/* Header with title and description */}
          <div className="space-y-2 text-center">
            <h1 className="text-3xl font-bold">Password Generator</h1>
            <p className="text-red-900 dark:text-red-950">
